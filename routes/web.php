...
Route::group(['prefix' => 'admin','middleware'=>'auth'],function(){
	Route::group(['prefix' => 'artist'],function(){
			...
			Route::post('admin/searchartist', 'ArtistController@searchadmin');
	});
	...
	Route::group(['prefix' => 'file'],function(){
			...
			Route::post('admin/search', 'FileController@searchadmin');
	});
...
Route::get('{id}/{slug_name}.html','PagesController@singer');
Route::any('profiledisfavorite', 'PagesController@profiledisfavorite');
Route::get('myplaylist','PagesController@favorite');
Route::get('{id}/{genre}','PagesController@genre');