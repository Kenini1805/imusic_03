                           ...
                           <div class="media">
                              ...
                              <div class="media-right">
                                 ...
                                 <h3 class="global-author">
                                    <a href="/dj/dj-dustee-2000022.html">{{$value->artist->name}}</a>
                                 </h3>
                              </div>
                           </div>
                           @endforeach
                        ...
                        @foreach($toptrack as $value)
                           <div class="media">
                              ...
                              <div class="media-body">
                                 ...
                                 <h3 class="global-author">
                                    <a href="/dj/soobin-hoang-son-2000078.html">{{$value->name}}</a>
                                    -                                             <a href="/dj/touliver-2000017.html">{{$value->artist->name}}</a>
                                 </h3>
                                 <h3 class="global-tag">
                                    <a href="/tracks/?genre=2000004">#{{$value->genre->name}}</a>
                                 </h3>
                              </div>
                           </div>
                        @endforeach
