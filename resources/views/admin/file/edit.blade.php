        ...
        <!-- ... Your content goes here ... -->
            ...
            {{csrf_field()}}
                ...
                <div class="form-group">
                    ...
                    <label>Lượt xem theo tuần </label>
                    <input class="form-control" id="view_count_week" type="text" placeholder="Input name" value="{{$file->viewcountweek}} " name="view_count_week" required>
                    <label>Người up</label>
                    <input class="form-control" id="user" type="text" placeholder="Input name" value="{{ Auth::user()->name}} " readonly="true" name="user" required>
                    <label>Lyric</label>
                    <textarea class="form-control" name="lyrics" rows="3" placeholder="Enter Description"  cols="50">{{$file->lyrics}}</textarea>
                <div class="form-group">
