        ...
        <!-- ... Your content goes here ... -->
            ...
            {{csrf_field()}}
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="view_count_week" type="text" placeholder="Input name" value="{!! old('name') !!} " name="view_count_week" required>
                    ...
                    <label>Lyric</label>
                    <textarea class="form-control" rows="3" placeholder="Enter Description" name="lyrics" cols="50"></textarea>
                </div>
                <div class="form-group">
